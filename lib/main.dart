...
import 'package:munozdrawerpaginas/privacy_policy.dart';
import 'package:munozdrawerpaginas/send_feedback.dart';
import 'package:munozdrawerpaginas/settings.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xfff8cef2),
        title: Text("Munoz Drawer"),
      ),
      body: container,
      drawer: Drawer(
